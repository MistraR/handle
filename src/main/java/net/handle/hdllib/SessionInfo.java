...
public class SessionInfo {
    ...
    public byte[] encryptBuffer(byte buf[], int offset, int len) throws HandleException {
        try {
            ...
            Cipher encryptCipher = provider.getCipher(algorithmCode, sessionKey, javax.crypto.Cipher.ENCRYPT_MODE, null, majorProtocolVersion, minorProtocolVersion);
    ...
    public byte[] decryptBuffer(byte buf[], int offset, int len) throws HandleException {
        try {
            ...
            Cipher decryptCipher = provider.getCipher(algorithmCode, sessionKey, javax.crypto.Cipher.DECRYPT_MODE, iv, majorProtocolVersion, minorProtocolVersion);
