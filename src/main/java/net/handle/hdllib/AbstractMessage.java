...
public abstract class AbstractMessage implements Cloneable {
    ...
    public boolean hasEqualOrGreaterVersion(int majorVersion, int minorVersion) {
        if (majorProtocolVersion == 5) return majorVersion == 5 && minorProtocolVersion >= minorVersion; // apparently really old client used 5 by mistake
     ...
     * </pre>
     *******************************************************************************/
    public final void signMessage(Signature signer) throws HandleException, java.security.SignatureException {
