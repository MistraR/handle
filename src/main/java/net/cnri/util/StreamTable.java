...
public class StreamTable extends Hashtable<String, Object> implements StreamObject, DeepClone {
    ...
    public void writeToFile(String fileName, boolean sync) throws java.io.IOException {
    ...
    public void writeToFile(File file, boolean sync) throws java.io.IOException {
